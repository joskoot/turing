...
; "Copied from “Formal Languages and their Relation to Automata”,")
; "Addison-Wesley} 1969 p 105-107 (ISBN 0-201-0298 3-9)")
; "I have replaced the entries in column mc")
; "and rows TL0, TL1, TR0 and TR1 by an R.")
; "In the book these are an underscore, but that does not work.")
...
; "The following puts a 0 in front of the data m1 1 1.")
(define input
'(c c mc
  0           c 0           c   1 1 R 0
  c c
