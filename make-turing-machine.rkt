...
but symbols and exact integer numbers are preferred.
...
the move being made and the content of the tape after the move has been made.
...
Heading and trailing user-blanks and machine-blanks are removed from the output before returning.
